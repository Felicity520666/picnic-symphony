...
const ingredientDefinitions = [
  ...
  },
  {
    ...
    play(time, ctx, gain) {
      ...
      const g = ctx.createGain();
      g.gain.setValueAtTime(0.0001, time);
      g.gain.linearRampToValueAtTime(0.03, time + 0.002);
  ...
  // ─── BASS ──────────────────────────────────────────────
  {
    ...
    play(time, ctx, gain, step) {
      ...
      g.gain.setValueAtTime(0.0001, time);
      g.gain.linearRampToValueAtTime(0.04, time + 0.008);
  ...
  // ─── MELODY ────────────────────────────────────────────
  {
    ...
    play(time, ctx, gain, step) {
      ...
      osc.frequency.setValueAtTime(freq, time);
      g.gain.setValueAtTime(0.0001, time);
      g.gain.linearRampToValueAtTime(0.035, time + 0.01);
  ...
  },
  {
    ...
    play(time, ctx, gain, step) {
      ...
      osc.frequency.setValueAtTime(freq, time);
      g.gain.setValueAtTime(0.0001, time);
      g.gain.linearRampToValueAtTime(0.035, time + 0.008);
  ...
  },
  {
    ...
    play(time, ctx, gain, step) {
      ...
      osc.frequency.setValueAtTime(freq, time);
      g.gain.setValueAtTime(0.0001, time);
      g.gain.linearRampToValueAtTime(0.03, time + 0.003);
  ...
  // ─── HARMONY ───────────────────────────────────────────
  {
    ...
    play(time, ctx, gain, step) {
      ...
      gG.gain.linearRampToValueAtTime(0.025, time + 0.1);
      gG.gain.linearRampToValueAtTime(0.025, time + 1.2);
  ...
  },
  {
    ...
    play(time, ctx, gain) {
      ...
      g.gain.linearRampToValueAtTime(0.02, time + 2.0);
  ...
  },
  {
    ...
    play(time, ctx, gain) {
      ...
      const g = ctx.createGain();
      g.gain.setValueAtTime(0.0001, time);
      g.gain.linearRampToValueAtTime(0.012, time + 0.002);

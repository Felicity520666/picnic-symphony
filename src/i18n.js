...
const translations = {
  en: {
    ...
    'export.loops': 'Loops',
    'export.lengthMode': 'Export Length',
    'export.modeLoops': 'Loop Count',
    'export.modeDuration': 'Total Duration',
    ...
    'export.largeWarning': 'Large file — may take a moment.',
  ...
  zh: {
    ...
    'export.volume': '导出音量',
    'export.loops': '循环次数',
    'export.lengthMode': '导出长度',
    'export.modeLoops': '按循环次数',
    'export.modeDuration': '按总时长',
    'export.duration': '总时长',
    'export.startButton': '导出 WAV',
    'export.rendering': '正在生成音频……',
    'export.ready': '你的音乐已准备好！',
    'export.error': '导出失败，请重试。',
    'export.largeWarning': '文件较大，可能需要一些时间。',
  ...
  fr: {
    ...
    'postcard.download': 'Télécharger la carte',
    'postcard.downloadAudio': 'Télécharger l\'audio',
    'postcard.audioExporting': 'Exportation…',
    'export.title': 'Exporter votre musique',
    'export.volume': 'Volume d\'export',
    'export.loops': 'Boucles',
    'export.lengthMode': 'Durée d\'export',
    'export.modeLoops': 'Nombre de boucles',
    'export.modeDuration': 'Durée totale',
    'export.duration': 'Durée',
    'export.startButton': 'Exporter WAV',
    'export.rendering': 'Création de l\'audio…',
    'export.ready': 'Votre musique est prête !',
    'export.error': 'Échec de l\'export. Réessayez.',
    'export.largeWarning': 'Fichier volumineux — peut prendre un moment.',
  ...
  es: {
    ...
    'postcard.download': 'Descargar postal',
    'postcard.downloadAudio': 'Descargar audio',
    'postcard.audioExporting': 'Exportando…',
    'export.title': 'Exportar tu música',
    'export.volume': 'Volumen de exportación',
    'export.loops': 'Bucles',
    'export.lengthMode': 'Duración de exportación',
    'export.modeLoops': 'Número de bucles',
    'export.modeDuration': 'Duración total',
    'export.duration': 'Duración',
    'export.startButton': 'Exportar WAV',
    'export.rendering': 'Generando audio…',
    'export.ready': '¡Tu música está lista!',
    'export.error': 'Error al exportar. Inténtalo de nuevo.',
    'export.largeWarning': 'Archivo grande — puede tardar un momento.',
  ...
  de: {
    ...
    'postcard.title': 'Deine Komposition', 'postcard.download': 'Postkarte laden', 'postcard.downloadAudio': 'Audio laden', 'postcard.audioExporting': 'Wird exportiert…', 'postcard.newPicnic': 'Neues Picknick',
    'export.title': 'Deine Musik exportieren', 'export.volume': 'Exportlautstärke', 'export.loops': 'Schleifen', 'export.lengthMode': 'Exportlänge', 'export.modeLoops': 'Schleifenanzahl', 'export.modeDuration': 'Gesamtdauer', 'export.duration': 'Dauer', 'export.startButton': 'WAV exportieren', 'export.rendering': 'Audio wird erzeugt…', 'export.ready': 'Deine Musik ist fertig!', 'export.error': 'Export fehlgeschlagen.', 'export.largeWarning': 'Große Datei — kann einen Moment dauern.',
  ...
  ja: {
    ...
    'postcard.title': 'あなたの作品', 'postcard.download': 'ポストカード', 'postcard.downloadAudio': '音声を保存', 'postcard.audioExporting': 'エクスポート中…', 'postcard.newPicnic': '新しいピクニック',
    'export.title': '音楽をエクスポート', 'export.volume': 'エクスポート音量', 'export.loops': 'ループ', 'export.lengthMode': 'エクスポート長さ', 'export.modeLoops': 'ループ回数', 'export.modeDuration': '合計時間', 'export.duration': '時間', 'export.startButton': 'WAV エクスポート', 'export.rendering': '音声を生成中…', 'export.ready': '音楽の準備ができました！', 'export.error': 'エクスポートに失敗しました。', 'export.largeWarning': '大きなファイル — 時間がかかる場合があります。',
  ...
  hi: {
    ...
    'postcard.title': 'आपकी रचना', 'postcard.download': 'पोस्टकार्ड', 'postcard.downloadAudio': 'ऑडियो डाउनलोड', 'postcard.audioExporting': 'निर्यात हो रहा…', 'postcard.newPicnic': 'नई पिकनिक',
    'export.title': 'अपना संगीत निर्यात करें', 'export.volume': 'निर्यात आवाज़', 'export.loops': 'लूप', 'export.lengthMode': 'निर्यात लंबाई', 'export.modeLoops': 'लूप संख्या', 'export.modeDuration': 'कुल अवधि', 'export.duration': 'अवधि', 'export.startButton': 'WAV निर्यात', 'export.rendering': 'ऑडियो बन रहा…', 'export.ready': 'आपका संगीत तैयार है!', 'export.error': 'निर्यात विफल। पुनः प्रयास करें।', 'export.largeWarning': 'बड़ी फ़ाइल — कुछ समय लग सकता है।',
  ...
  ar: {
    ...
    'postcard.title': 'عملك', 'postcard.download': 'تنزيل البطاقة', 'postcard.downloadAudio': 'تنزيل الصوت', 'postcard.audioExporting': 'جارٍ التصدير…', 'postcard.newPicnic': 'نزهة جديدة',
    'export.title': 'تصدير موسيقاك', 'export.volume': 'مستوى الصوت', 'export.loops': 'تكرارات', 'export.lengthMode': 'مدة التصدير', 'export.modeLoops': 'عدد التكرارات', 'export.modeDuration': 'المدة الإجمالية', 'export.duration': 'المدة', 'export.startButton': 'تصدير WAV', 'export.rendering': 'جارٍ إنشاء الصوت…', 'export.ready': 'موسيقاك جاهزة!', 'export.error': 'فشل التصدير. حاول مجددًا.', 'export.largeWarning': 'ملف كبير — قد يستغرق بعض الوقت.',
  ...
  ko: {
    ...
    'postcard.title': '나의 작품', 'postcard.download': '엽서 다운로드', 'postcard.downloadAudio': '오디오 다운로드', 'postcard.audioExporting': '내보내는 중…', 'postcard.newPicnic': '새 피크닉',
    'export.title': '음악 내보내기', 'export.volume': '내보내기 음량', 'export.loops': '루프', 'export.lengthMode': '내보내기 길이', 'export.modeLoops': '루프 횟수', 'export.modeDuration': '총 시간', 'export.duration': '시간', 'export.startButton': 'WAV 내보내기', 'export.rendering': '오디오 생성 중…', 'export.ready': '음악이 준비되었습니다!', 'export.error': '내보내기 실패. 다시 시도하세요.', 'export.largeWarning': '큰 파일 — 시간이 걸릴 수 있습니다.',

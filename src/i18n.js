...
const translations = {
  ...
  de: {
    ...
    'studio.pickRecipe': 'Wähle eine Zutat, um zu beginnen.', 'studio.finish': 'Fertig', 'studio.recipeBook': 'Rezepte', 'studio.nextBadge': 'Weiter', 'nav.home': 'Startseite',
  ...
  ja: {
    ...
    'studio.pickRecipe': '音をひとつ選んで始めましょう。', 'studio.finish': '完成', 'studio.recipeBook': 'レシピ', 'studio.nextBadge': '次', 'nav.home': 'ホーム',
  ...
  hi: {
    ...
    'studio.pickRecipe': 'शुरू करने के लिए एक सामग्री चुनें।', 'studio.finish': 'पूरा करें', 'studio.recipeBook': 'रेसिपी', 'studio.nextBadge': 'अगला', 'nav.home': 'मुखपृष्ठ',
  ...
  ar: {
    ...
    'studio.pickRecipe': 'اختر مكوّنًا للبدء.', 'studio.finish': 'إنهاء', 'studio.recipeBook': 'الوصفات', 'studio.nextBadge': 'التالي', 'nav.home': 'الرئيسية',
  ...
  ko: {
    ...
    'studio.pickRecipe': '시작할 재료를 선택하세요.', 'studio.finish': '완성', 'studio.recipeBook': '레시피', 'studio.nextBadge': '다음', 'nav.home': '홈',
